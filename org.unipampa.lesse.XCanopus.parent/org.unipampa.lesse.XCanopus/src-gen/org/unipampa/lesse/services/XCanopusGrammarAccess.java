...
public class XCanopusGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class MonitoringElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cMonitoringKeyword_1 = (Keyword)cGroup.eContents().get(1);
		...
		private final Keyword cSUTKeyword_6 = (Keyword)cGroup.eContents().get(6);
		private final RuleCall cEStringParserRuleCall_7 = (RuleCall)cGroup.eContents().get(7);
		private final Keyword cMonitored_byKeyword_8 = (Keyword)cGroup.eContents().get(8);
		private final Keyword cSUTKeyword_9 = (Keyword)cGroup.eContents().get(9);
		private final Keyword cMonitorKeyword_10 = (Keyword)cGroup.eContents().get(10);
		...
		//	EString
		//	'{'
		//	'Given' "that" 'SUT' EString "monitored_by" 'SUT' "monitor"
		//	'And'
		//	'}';
		@Override public ParserRule getRule() { return rule; }
		
		//{Monitoring} 'Monitoring' EString '{' 'Given' "that" 'SUT' EString "monitored_by" 'SUT' "monitor" 'And' '}'
		public Group getGroup() { return cGroup; }
		...
		//'Monitoring'
		public Keyword getMonitoringKeyword_1() { return cMonitoringKeyword_1; }
		...
		//'SUT'
		public Keyword getSUTKeyword_6() { return cSUTKeyword_6; }
		
		//EString
		public RuleCall getEStringParserRuleCall_7() { return cEStringParserRuleCall_7; }
		
		//"monitored_by"
		public Keyword getMonitored_byKeyword_8() { return cMonitored_byKeyword_8; }
		
		//'SUT'
		public Keyword getSUTKeyword_9() { return cSUTKeyword_9; }
		
		//"monitor"
		public Keyword getMonitorKeyword_10() { return cMonitorKeyword_10; }
	...
	public class SUTElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cTypeSUT_TYPEEnumRuleCall_6_1_0 = (RuleCall)cTypeAssignment_6_1.eContents().get(0);
		...
		//	{SUT}
		//	'SUT'
		//	'{' ('hostname' hostname=EString)? ('ip' ip=EString)? ('hardware' hardware=HARDWARE)? ('type' type=SUT_TYPE)? ('sut'
		//	'(' sut+=[SUT|EString] ("," sut+=[SUT|EString])* ')')? ('metricmodel' metricmodel=[MetricModel|EString])?
		//	'}';
		@Override public ParserRule getRule() { return rule; }
		
		//{SUT} 'SUT' '{' ('hostname' hostname=EString)? ('ip' ip=EString)? ('hardware' hardware=HARDWARE)? ('type'
		//type=SUT_TYPE)? ('sut' '(' sut+=[SUT|EString] ("," sut+=[SUT|EString])* ')')? ('metricmodel'
		...
		//SUT_TYPE
		public RuleCall getTypeSUT_TYPEEnumRuleCall_6_1_0() { return cTypeSUT_TYPEEnumRuleCall_6_1_0; }
