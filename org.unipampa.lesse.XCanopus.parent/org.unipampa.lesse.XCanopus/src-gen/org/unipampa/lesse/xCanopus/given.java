 ...
 * </p>
 * <ul>
 *   <li>{@link org.unipampa.lesse.xCanopus.given#getSut1 <em>Sut1</em>}</li>
 *   <li>{@link org.unipampa.lesse.xCanopus.given#getSuttype <em>Suttype</em>}</li>
 *   <li>{@link org.unipampa.lesse.xCanopus.given#getSut2 <em>Sut2</em>}</li>
 * </ul>
 *
 * @see org.unipampa.lesse.xCanopus.XCanopusPackage#getgiven()
 * @model
 * @generated
 */
public interface given extends STEPS
{
   ...
   * @see #setSut1(SUT)
   * @see org.unipampa.lesse.xCanopus.XCanopusPackage#getgiven_Sut1()
   * @model
   * @generated
   */
  SUT getSut1();
  ...
  /**
   * Sets the value of the '{@link org.unipampa.lesse.xCanopus.given#getSut1 <em>Sut1</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.unipampa.lesse.xCanopus.XCanopusPackage#getgiven_Suttype()
   * @model
   * @generated
   */
  SUT_TYPE getSuttype();
  ...
  /**
   * Sets the value of the '{@link org.unipampa.lesse.xCanopus.given#getSuttype <em>Suttype</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setSut2(SUT)
   * @see org.unipampa.lesse.xCanopus.XCanopusPackage#getgiven_Sut2()
   * @model
   * @generated
   */
  SUT getSut2();
  ...
  /**
   * Sets the value of the '{@link org.unipampa.lesse.xCanopus.given#getSut2 <em>Sut2</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
