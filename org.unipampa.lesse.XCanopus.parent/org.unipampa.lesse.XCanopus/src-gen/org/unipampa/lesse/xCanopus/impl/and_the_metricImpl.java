...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>and the metric</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.unipampa.lesse.xCanopus.impl.and_the_metricImpl#getMetric <em>Metric</em>}</li>
 *   <li>{@link org.unipampa.lesse.xCanopus.impl.and_the_metricImpl#getInteger1 <em>Integer1</em>}</li>
 *   <li>{@link org.unipampa.lesse.xCanopus.impl.and_the_metricImpl#getInteger2 <em>Integer2</em>}</li>
 *   <li>{@link org.unipampa.lesse.xCanopus.impl.and_the_metricImpl#getInteger3 <em>Integer3</em>}</li>
 * </ul>
 *
 * @generated
 */
public class and_the_metricImpl extends STEPSImpl implements and_the_metric
{
  /**
  ...
  {
    return XCanopusPackage.Literals.AND_THE_METRIC;
  }
  ...
  public void setMetric(METRICTYPE newMetric)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XCanopusPackage.AND_THE_METRIC__METRIC, oldMetric, metric));
  }
  ...
  public void setInteger1(int newInteger1)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XCanopusPackage.AND_THE_METRIC__INTEGER1, oldInteger1, integer1));
  }
  ...
  public void setInteger2(int newInteger2)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XCanopusPackage.AND_THE_METRIC__INTEGER2, oldInteger2, integer2));
  }
  ...
  public void setInteger3(int newInteger3)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XCanopusPackage.AND_THE_METRIC__INTEGER3, oldInteger3, integer3));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XCanopusPackage.AND_THE_METRIC__METRIC:
        return getMetric();
      case XCanopusPackage.AND_THE_METRIC__INTEGER1:
        return getInteger1();
      case XCanopusPackage.AND_THE_METRIC__INTEGER2:
        return getInteger2();
      case XCanopusPackage.AND_THE_METRIC__INTEGER3:
        return getInteger3();
    }
