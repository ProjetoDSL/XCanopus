 ...
 * </p>
 * <ul>
 *   <li>{@link org.unipampa.lesse.xCanopus.impl.DiskImpl#getDisk_io_counter <em>Disk io counter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiskImpl extends MetricImpl implements Disk
{
  ...
  {
    return XCanopusPackage.Literals.DISK;
  }
    ...
    if (disk_io_counter != null && disk_io_counter.eIsProxy())
    {
      ...
      if (disk_io_counter != oldDisk_io_counter)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, XCanopusPackage.DISK__DISK_IO_COUNTER, oldDisk_io_counter, disk_io_counter));
      }
    }
  ...
  public void setDisk_io_counter(Disk_IO_Counter newDisk_io_counter)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XCanopusPackage.DISK__DISK_IO_COUNTER, oldDisk_io_counter, disk_io_counter));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XCanopusPackage.DISK__DISK_IO_COUNTER:
