 ...
 * <!-- end-user-doc -->
 * @see org.unipampa.lesse.xCanopus.XCanopusPackage#getCOUNTER_TRANSACTION()
 * @model
 * @generated
 */
public enum COUNTER_TRANSACTION implements Enumerator
{
   ...
   * @ordered
   */
  TRANSACTION_RESPONSE_TIME(0, "TRANSACTION_RESPONSE_TIME", "TRANSACTION_RESPONSE_TIME"),
   ...
   * @ordered
   */
  TRANSACTION_PER_SECOND_TPS(1, "TRANSACTION_PER_SECOND_TPS", "TRANSACTION_PER_SECOND_TPS"),
   ...
   * @ordered
   */
  TRANSACTION_SUCCESS_RATE(2, "TRANSACTION_SUCCESS_RATE", "TRANSACTION_SUCCESS_RATE");
