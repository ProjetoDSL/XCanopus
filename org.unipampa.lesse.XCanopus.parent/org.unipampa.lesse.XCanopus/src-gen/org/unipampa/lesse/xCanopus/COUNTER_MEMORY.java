 ...
 * <!-- end-user-doc -->
 * @see org.unipampa.lesse.xCanopus.XCanopusPackage#getCOUNTER_MEMORY()
 * @model
 * @generated
 */
public enum COUNTER_MEMORY implements Enumerator
{
   ...
   * @ordered
   */
  AVALIABLE_MBYTES_COUNTER(0, "AVALIABLE_MBYTES_COUNTER", "AVALIABLE_MBYTES_COUNTER"),
   ...
   * @ordered
   */
  PAGES_SEC_COUNTER(1, "PAGES_SEC_COUNTER", "PAGES_SEC_COUNTER"),
   ...
   * @ordered
   */
  PAGE_READS_SEC_COUNTER(2, "PAGE_READS_SEC_COUNTER", "PAGE_READS_SEC_COUNTER"),
   ...
   * @ordered
   */
  WORKING_SET_COUNTER(3, "WORKING_SET_COUNTER", "WORKING_SET_COUNTER"),
   ...
   * @ordered
   */
  POOL_NONPAGE_BYTES_COUNTER(4, "POOL_NONPAGE_BYTES_COUNTER", "POOL_NONPAGE_BYTES_COUNTER"),
   ...
   * @ordered
   */
  PAGED_POOL_BYTES_COUNTER(5, "PAGED_POOL_BYTES_COUNTER", "PAGED_POOL_BYTES_COUNTER"),
   ...
   * @ordered
   */
  PAGED_POOL_FAILURES_COUNTER(6, "PAGED_POOL_FAILURES_COUNTER", "PAGED_POOL_FAILURES_COUNTER"),
   ...
   * @ordered
   */
  CACHE_BYTES_COUNTER(7, "CACHE_BYTES_COUNTER", "CACHE_BYTES_COUNTER");
