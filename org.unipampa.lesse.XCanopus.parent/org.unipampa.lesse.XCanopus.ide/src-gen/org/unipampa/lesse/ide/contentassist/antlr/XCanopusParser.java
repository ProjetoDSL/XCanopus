...
public class XCanopusParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, XCanopusGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPOSTCONDITIONAccess().getAlternatives(), "rule__POSTCONDITION__Alternatives");
			...
			builder.put(grammarAccess.getMonitoringAccess().getSutAssignment_9(), "rule__Monitoring__SutAssignment_9");
			builder.put(grammarAccess.getMonitoringAccess().getSut_typeAssignment_10(), "rule__Monitoring__Sut_typeAssignment_10");
			builder.put(grammarAccess.getMonitoringAccess().getSutAssignment_12(), "rule__Monitoring__SutAssignment_12");
			builder.put(grammarAccess.getMonitoringAccess().getConditionAssignment_14(), "rule__Monitoring__ConditionAssignment_14");
			builder.put(grammarAccess.getMonitoringAccess().getSutAssignment_15(), "rule__Monitoring__SutAssignment_15");
			builder.put(grammarAccess.getMonitoringAccess().getSut_type2Assignment_18(), "rule__Monitoring__Sut_type2Assignment_18");
			builder.put(grammarAccess.getMonitoringAccess().getSutAssignment_20(), "rule__Monitoring__SutAssignment_20");
			builder.put(grammarAccess.getANDAccess().getPostAssignment_1(), "rule__AND__PostAssignment_1");
			builder.put(grammarAccess.getWHENAccess().getPostAssignment_1(), "rule__WHEN__PostAssignment_1");
			builder.put(grammarAccess.getTHENAccess().getPostAssignment_1(), "rule__THEN__PostAssignment_1");
			builder.put(grammarAccess.getPOSTCONDITIONAccess().getWGTAssignment_0(), "rule__POSTCONDITION__WGTAssignment_0");
			builder.put(grammarAccess.getPOSTCONDITIONAccess().getTHEAssignment_1(), "rule__POSTCONDITION__THEAssignment_1");
			builder.put(grammarAccess.getPOSTCONDITIONAccess().getATLAssignment_2(), "rule__POSTCONDITION__ATLAssignment_2");
